app.controller('relatorioCtrl', function ($scope, $rootScope, $http, $location, dataservice) {
    ...
    function drawChartPagamento() {
        ...
        saidas.forEach(function (mov) {
            ...
            var index = lstChart.findIndex(function (itemChart) {
        ...
        var options = {
            title: 'Saídas por Tipo de Movimentação',
            animation: {
                duration: 1000,
                easing: 'out',
            },
    ...
    function drawChartGasto() {
        ...
        saidas.forEach(function (mov) {
            ...
            //verifica se existe na lstChart
            var index = lstChart.findIndex(function (itemChart) {
                return itemChart[0].id == mov.tipoPagamento.id;
            });
        ...
        lstChart.unshift(["Tipo de Pagamento", "Valor"])

        var data = google.visualization.arrayToDataTable(lstChart);

        var options = {
            title: 'Saidas por Tipo de Pagamento',
            animation: {
                duration: 1000,
                easing: 'out',
            },
